...
namespace EdutalkTeacherUWP.Home.Models
{
    ...
    public class RouteModel : ModelBase
    {
        ...
        public bool IsNextLesson { set; get; }
        ...
        //public void OnVisibleUpdateSupportClassForTutorChanged()
        //{
        //    RaisePropertyChanged(nameof(VisibleFeedbackForTutor));
        //    RaisePropertyChanged(nameof(VisibleAttendanceForTutor));
        //}
    ...
    public class SupportClassModel : ModelBase
    {
        public long Id { get; set; }
        public string Note { get; set; }
    }

    public class RouteItemModel : ModelBase
    {
