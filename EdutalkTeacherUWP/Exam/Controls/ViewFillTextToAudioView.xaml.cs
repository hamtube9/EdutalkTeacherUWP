...
namespace EdutalkTeacherUWP.Exam.Controls
{
    ...
    /// </summary>
    public sealed partial class ViewFillTextToAudioView : UserControl
    {

        public static readonly DependencyProperty GroupQuestionProperty = DependencyProperty.Register("GroupQuestion", typeof(GroupQuestionModel), typeof(ViewFillTextToAudioView), new PropertyMetadata(null));
        ...
        public ViewFillTextToAudioView()
        {
